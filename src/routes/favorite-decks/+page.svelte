<main style="height: calc(100vh - 47px)" class="bg-gradient-to-r from-gray-900 via-sky-950 to-gray-900 w-screen h-screen flex-col justify-center items-start bg-sky-950 overflow-y-auto">	
	<h1 class="border-b-2 border-r border-t border-l border-sky-300 text-center text-lg mt-10 mb-12 text-white bg-sky-800 w-[220px] mx-auto px-2 pb-1 pt-1.5 font-light rounded-br-md rounded-tl-md">Your favorite decks</h1>
